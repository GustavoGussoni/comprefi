...
export const iphonesNovosProducts: GroupedProduct[] = [
  {
    ...
    colors: [
      {
        ...
        gallery: [iphone17PMP2, iphone17PMP3],
      },
      {
        name: "Azul",
        hex: "#5B7BA5",
        image: iphone17PMATraseira,
        gallery: [iphone17PMA2, iphone17PMA3],
      },
      {
        name: "Laranja",
        hex: "#E8702A",
        image: iphone17PMLTraseira,
        gallery: [iphone17PML1, iphone17PML3],
      },
    ],
    colorsByStorage: {
    ...
    pricing: {
      "256GB-Prata": {
        originalPrice: "R$ 9.700,00",
        installmentPrice: "R$ 852,00",
        pixPrice: "R$ 8.962,00",
      },
      "256GB-Azul": {
        originalPrice: "R$ 9.583,00",
        installmentPrice: "R$ 841,00",
        pixPrice: "R$ 8.854,00",
      },
      "256GB-Laranja": {
        originalPrice: "R$ 9.465,00",
        installmentPrice: "R$ 831,00",
        pixPrice: "R$ 8.745,00",
      },
      "512GB-Prata": {
        originalPrice: "R$ 12.524,00",
        installmentPrice: "R$ 1.099,00",
        pixPrice: "R$ 11.571,00",
      },
      "512GB-Azul": {
        originalPrice: "R$ 12.406,00",
        installmentPrice: "R$ 1.089,00",
        pixPrice: "R$ 11.462,00",
      },
      "512GB-Laranja": {
        originalPrice: "R$ 11.406,00",
        installmentPrice: "R$ 1.001,00",
        pixPrice: "R$ 10.538,00",
      },
      "1TB-Prata": {
        originalPrice: "R$ 13.818,00",
        installmentPrice: "R$ 1.213,00",
        pixPrice: "R$ 12.767,00",
      },
      "1TB-Azul": {
        originalPrice: "R$ 13.583,00",
        installmentPrice: "R$ 1.192,00",
        pixPrice: "R$ 12.549,00",
      },
      "1TB-Laranja": {
        originalPrice: "R$ 12.994,00",
        installmentPrice: "R$ 1.140,80",
        pixPrice: "R$ 12.006,00",
      },
      "2TB-Prata": {
        originalPrice: "R$ 15.406,00",
        installmentPrice: "R$ 1.353,00",
        pixPrice: "R$ 14.234,00",
      },
      "2TB-Azul": {
        originalPrice: "R$ 15.230,00",
        installmentPrice: "R$ 1.337,00",
        pixPrice: "R$ 14.071,00",
      },
      "2TB-Laranja": {
        originalPrice: "R$ 15.230,00",
        installmentPrice: "R$ 1.337,00",
  ...
  },
  {
    ...
    pricing: {
      "256GB-Prata": {
        ...
        installmentPrice: "R$ 759,00",
        pixPrice: "R$ 7.984,00",
      },
      "256GB-Azul": {
        originalPrice: "R$ 8.524,00",
        installmentPrice: "R$ 768,98",
        pixPrice: "R$ 7.875,00",
      },
      "256GB-Laranja": {
        originalPrice: "R$ 8.630,00",
        installmentPrice: "R$ 758,00",
        pixPrice: "R$ 7.973,00",
      },
      "512GB-Prata": {
        originalPrice: "R$ 11.112,00",
        installmentPrice: "R$ 976,00",
        pixPrice: "R$ 10.267,00",
      },
      "512GB-Laranja": {
        originalPrice: "R$ 10.994,00",
        installmentPrice: "R$ 965,22",
        pixPrice: "R$ 10.158,00",
      },
      "1TB-Laranja": {
        originalPrice: "R$ 13.112,00",
        installmentPrice: "R$ 1.151,00",
        pixPrice: "R$ 12.114,00",
      },
    },
  },
  {
    ...
    colors: [
      {
        name: "Preto",
        hex: "#1C1C1E",
        image: iphoneAirPTraseira,
        gallery: [iphoneAirP2, iphoneAirP3],
      },
      {
        name: "Branco",
        hex: "#F5F5F0",
        image: iphoneAirBTraseira,
        gallery: [iphoneAirB2, iphoneAirB3],
      },
      {
        name: "Dourado",
        hex: "#D4AF37",
        image: iphoneAirDTraseira,
        gallery: [iphoneAirD2, iphoneAirD3],
      },
      {
        name: "Azul",
        hex: "#5B7BA5",
        image: iphoneAirATraseira,
        gallery: [iphoneAirA2, iphoneAirA3],
      },
    ],
    colorsByStorage: {
    ...
    pricing: {
      "256GB-Preto": {
        originalPrice: "R$ 6.524,00",
        installmentPrice: "R$ 573,90",
        pixPrice: "R$ 6.028,00",
      },
      "256GB-Branco": {
        originalPrice: "R$ 6.406,00",
        installmentPrice: "R$ 562,57",
        pixPrice: "R$ 5.919,00",
      },
      "256GB-Dourado": {
        originalPrice: "R$ 6.406,00",
      ...
      "256GB-Azul": {
        originalPrice: "R$ 6.465,00",
        installmentPrice: "R$ 567,57",
        pixPrice: "R$ 5.973,00",
      },
      "512GB-Branco": {
  ...
  },
  {
    ...
    battery: "100%",
    specs:
      "iPhone 17 (lançado em setembro de 2025) destaca-se pela tela Super Retina XDR OLED de 6,3 polegadas com Dynamic Island e tecnologia ProMotion até 120 Hz. É equipado com chip A19 de última geração e sistema de câmeras duplo Fusion de 48 MP com câmera frontal 18 MP com Center Stage.",
    storages: ["256GB"],
    colors: [
      {
        name: "Preto",
        hex: "#1C1C1E",
        image: iphone17PTraseira,
        gallery: [iphone17P2, iphone17P3],
      },
      {
        name: "Branco",
        hex: "#F5F5F0",
        image: iphone17BTraseiraNovo,
        gallery: [iphone17B2, iphone17B3],
      },
      {
        name: "Azul",
        hex: "#5B7BA5",
        image: iphone17ATraseira,
        gallery: [iphone17A2, iphone17A3],
      },
      {
        name: "Salvia",
        hex: "#9CAF88",
        image: iphone17STraseira,
        gallery: [iphone17S2, iphone17S3],
      },
      {
        name: "Lavanda",
        hex: "#B4A7D6",
        image: iphone17LTraseira,
    ...
    pricing: {
      "256GB-Lavanda": {
        originalPrice: "R$ 6.171,00",
        installmentPrice: "R$ 541,25",
        pixPrice: "R$ 5.701,00",
      },
      "256GB-Branco": {
        originalPrice: "R$ 6.112,00",
        installmentPrice: "R$ 537,00",
        pixPrice: "R$ 5.647,00",
      },
      "256GB-Preto": {
        originalPrice: "R$ 6.112,00",
      ...
      "256GB-Salvia": {
        originalPrice: "R$ 5.994,00",
        installmentPrice: "R$ 526,00",
        pixPrice: "R$ 5.538,00",
      },
      "256GB-Azul": {
        originalPrice: "R$ 5.994,00",
  ...
  },
  {
    ...
    battery: "100%",
    specs:
      "iPhone 16 (lançado em setembro de 2024) destaca-se pela tela Super Retina XDR OLED de 6,1 polegadas com Dynamic Island, HDR e True Tone. É equipado com o chip A18 de nova geração, 8 GB de RAM e sistema de câmera duplo de 48 MP com recursos avançados de fotografia.",
    storages: ["128GB"],
    colors: [
      {
        name: "Preto",
        hex: "#1C1C1E",
        image: iphone16PTraseiraNovo,
        gallery: [iphone16P2, iphone16P3, iphone16P4],
      },
      {
        name: "Branco",
        hex: "#F5F5F0",
        image: iphone16BTraseiraNovo,
        gallery: [iphone16B2, iphone16B3, iphone16B4],
      },
      {
        name: "Rosa",
        hex: "#F4C2C2",
        image: iphone16RTraseira,
        gallery: [iphone16R2, iphone16R3, iphone16R4],
      },
      {
        name: "Ultramarino",
        hex: "#3F51B5",
        image: iphone16UTraseira,
        gallery: [iphone16U2, iphone16U3, iphone16U4],
      },
      {
        name: "Verde",
        hex: "#4CAF50",
        image: iphone16VTraseiraNovo,
    ...
    pricing: {
      "128GB": {
        originalPrice: "R$ 5.465,00",
        installmentPrice: "R$ 475,78",
        pixPrice: "R$ 4.995,00",
      },
  ...
  },
  {
    ...
    battery: "100%",
    specs:
      "iPhone 15 (lançado em setembro de 2023) destaca-se pela tela Super Retina XDR OLED de 6,1 polegadas com Dynamic Island. É equipado com o chip A16 Bionic e sistema de câmeras duplo com sensor principal de 48 MP e ultra-angular de 12 MP.",
    storages: ["128GB"],
    colors: [
      {
        name: "Preto",
        hex: "#1C1C1E",
        image: iphone15PTraseiraNovo,
        gallery: [],
      },
      {
        name: "Azul",
        hex: "#5B7BA5",
        image: iphone15ATraseira,
        gallery: [],
      },
      // Rosa indisponível no momento
      // { name: "Rosa", hex: "#F4C2C2", image: iphone15RTraseira, gallery: [] },
    ],
    pricing: {
      "128GB": {
        originalPrice: "R$ 4.550,00",
