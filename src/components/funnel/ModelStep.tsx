...
const ModelStep: React.FC<ModelStepProps> = ({ selectedModel, availableModels, onSelect }) => {
  ...
  const seriesOrder = ['iPhone 16', 'iPhone 15', 'iPhone 14', 'iPhone 13', 'iPhone 12', 'iPhone 11', 'iPhone SE'];
