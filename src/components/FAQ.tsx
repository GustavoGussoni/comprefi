  ...
  const faqItems = [
    {
      ...
      answer:
        "Todos os produtos são 100% originais. Os seminovos são testados rigorosamente antes de serem selecionados.",
    },
    {
      question: "Tem seguro?",
      answer:
        "Ao confirmar a compra, um contrato é enviado no seu WhatsApp ou e-mail para assinatura. Esse contrato protege indefinidamente ambos os lados.",
    },
    {
      question: "Quantos dias a entrega?",
      answer:
        "Para a região do Triângulo Mineiro, 1 a 2 dias úteis. Demais localidades, de 3 a 15 dias úteis.",
    },
  ];

  return (
    <div className="faq-section py-16 ">
